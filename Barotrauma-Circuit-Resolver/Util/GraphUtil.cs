...
namespace Barotrauma_Circuit_Resolver.Util
{
    public static class GraphUtil
    {
        ...
        ///     (data/storage will be assigned the lowest IDs to be updated first, so these links
        ///     form no sorting constraint)
        /// </summary>
                                           ...
                                           Dictionary<int, Mark> marks)
        {
            ...
            OnProgressUpdate
                ?.Invoke(0.5f + .25f * (componentGraph.VertexCount - head + tail) / componentGraph.VertexCount,
                         "Solving Update Order...");
